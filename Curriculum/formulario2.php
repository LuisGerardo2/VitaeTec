...
$Query2 = "SELECT * FROM datos WHERE usuario ='".$usuario."';";
...
?>
 ...
 <center>
    ...
    <br><br><br><legend>Datos personales</legend>
    ...
    <form class="form" action="RegistroF.php" method="POST" target="_blank" enctype="multipart/form-data">
        ...
        <div class="formulario" id="formulario1">
            ...
            <div class="contenedor">
                ...
                <div class="row">
                    <div class="col-25">
                        <label for="aniosTit1">Años en los que se estudio la titulación</label>
                    </div>
                    <div class="col-75">
                        <input type="number" id="añosTit1" name="aniosTit1" placeholder="xxxx-xxxx"></input>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-25">
                        <label for="aniosTit2">Años en los que se estudio la titulación</label>
                    </div>
                    <div class="col-75">
                        <input type="number" id="añosTit2" name="aniosTit2" placeholder="xxxx-xxxx"></input>
                    </div>
                </div>
        ...
        <div class="formulario" id="formulario3">
            ...
            <div class="contenedor">
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                        <textarea type="text" id="habilidades" name="habilidades" placeholder="Separe cada habilidad con comas (facilidad de palabra, pensamiento matematico)"></textarea>
                    </div>
                </div>
