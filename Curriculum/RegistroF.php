...
$sql ="INSERT INTO datos(usuario,foto,correo,NoTel,instagram,facebook,habilidades,noTel2,alos,lugar,cargo,funcion,Nombre,Apellidopat,Apellidomat,alosl,puesto,tutulo1,NombreUni1,aniosUni1,descrip1,tutulo2,NombreUni2,aniosUni2,descrip2,sobremi) VALUES ('$user','$foto','$correo','$notel','$instagram','$facebook','$habilidades','$notel2','$alos','$lugar','$cargo','$funcion','$nombre','$apellidopat','$apellidomat','$alosl','$puesto','$tutulo1','$NombreUni1','$aniosUni1','$descripUni1','$tutulo2','$NombreUni2','$aniosUni2','$descripUni2','$sobremi');";
